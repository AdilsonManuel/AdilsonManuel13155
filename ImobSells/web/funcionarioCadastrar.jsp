<%-- 
    ...
    Created on : 31-Jul-2021, 16:48:22
    Author     : azm
--%>
...
<html>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-11">
                <form class="main-form needs-validation" id="funcioanrioForm" name="funcioanrioForm" method="POST">
                    <fieldset>
                    ...
                    <div class="row">
                        <div class="form-control">
                            ...
                            <%= new HtmlComboBoxes ().select ("tipo_funcionario" , "clienteForm" , "comboTipoFuncionario" , "tipo_funcionario_pk" , "nome" , "" , "")%>
                        </div>
                    </div>
                    <hr>                     
                    <fieldset>
                    ...
                    <div class="row">
                        <div class="col-md-8" >
                            <input 
                                ...
                                value="Cadastrar"
                                onclick="guardarFormFuncionario('FuncionarioServlet?operacao=Cadastrar&&redirecionar=homeRoot.jsp')"
                                />
