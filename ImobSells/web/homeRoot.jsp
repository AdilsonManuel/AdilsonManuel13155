<%-- 
    Document   : homeRoot
    Created on : Jul 21, 2021, 9:39:39 AM
    Author     : azm
--%>
            ...
            <div class="container d-flex align-items-center">
                ...
                <nav id="navbar" class="navbar order-last order-lg-0">
                    <ul>
                        ...
                        <li class="dropdown">
                            <a href="#"><span>Defesa</span> <i class="bi bi-chevron-down"></i></a>
                            <ul>
                                <li><a href="Defesa.jsp">Projecto</a></li>
                            </ul>
                        </li>
                        <li class="dropdown">
                ...
                <a href="index.jsp" class="appointment-btn scrollto"><span class="d-none d-md-inline">Voltar</span>
                    Login</a>
            </div>
        </header>
        <!-- End Header -->
